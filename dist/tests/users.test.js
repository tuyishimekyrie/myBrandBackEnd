...
describe("/api/users", () => {
    ...
    describe("GET /getALL", () => {
        ...
        // it("should return 404 with users if user is not found", async () => {
        //   // Mock an admin user
        ...
        //   expect(response.status).toBe(200);
        //   // Expecting an array of users in the response body
        //   expect(response.body.users).toBeDefined();
        //   expect(Array.isArray(response.body.users)).toBe(true);
        //   // Assuming there are 2 mock users inserted
        //   // expect(response.body.users.length).toBe(2);
        // });
    ...
    describe("get current user", () => {
        describe("GET /api/users/me", () => {
            ...
            it("should return 401 if token is not provided", () => __awaiter(void 0, void 0, void 0, function* () {
                const userId = "65eaf11edd40e6f1317d288da"; // Replace this with your actual user ID
                const token = jsonwebtoken_1.default.sign({ _id: userId }, config_1.default.get("jwtPrivateKey"));
